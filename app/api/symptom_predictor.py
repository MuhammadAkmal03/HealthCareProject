...
def predict_diagnosis(request: SymptomPredictionRequest):
    ...
    try:
        # ===================================================================
        # THIS IS THE FIX:
        # model_dump(by_alias=True) tells Pydantic to create the dictionary
        # using the alias names ("Oxygen_Saturation_%") instead of the Python
        # variable names (oxygen_saturation_percent). This ensures the dictionary
        # passed to the service perfectly matches what the model was trained on.
        # ===================================================================
